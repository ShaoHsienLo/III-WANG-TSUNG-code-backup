...
def explain_model(rf, X_train, X_test, target_names=None):
    ...
    exp.save_to_file("./models/20221026/exp_v1.0.html")
...
# 讀檔
df = read_file(r"C:\Users\samuello\Downloads\III\旺欉\code\input-data", "input.csv")

# 處理類別資料
df_encoded, target_names = handle_categorical_data(df)
...
# 模型訓練
rf = model_training(X_train_norm, y_train)
