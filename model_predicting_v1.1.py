        ...
        if not data.empty:
            ...
            if (data["ingot"].iloc[0] > 390) & (time_df["ingot_start_time"].iloc[0] is None):
                ...
                if (data["oil_pressure"].iloc[0] > 120) & (time_df["oil_pressure_start_time"].iloc[0] is None):
                    ...
                    print("oil pressure start: ", time_df)
